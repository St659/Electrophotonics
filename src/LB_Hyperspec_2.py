...
import numpy as np
data_directory = '../Data/LB_Hyperspec_2'
results_directory = '../Results/LB_Hyperspec_2'
...
for directory in sorted_results_file:
    ...
    data_slice = slice(300,-1)
    side_slice = slice (300,-200)
...
image_average.set_ylim([835,840])
